...
<head>
    ...
    <!-- Title -->
    <title>Entro Launch | Blog Archive</title>
    <!-- Favicon -->
...
<body>
            ...
            <nav class="navbar navbar-expand-lg" id="d2c_main_nav">
                ...
                <div class="collapse navbar-collapse js-clone-nav justify-content-between">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="./blog_archive.php">Blog</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item d-block d-lg-none">
                            <a class="nav-link" href="./authentication/registration.php">Sign up</a>
                        </li>
                    </ul>
                    <div class="d2c_nav_btn d-none d-lg-block">
                        <a href="./authentication/login.php" class="nav-link d-inline-block">Login</a>
                        <a href="./authentication/registration.php" class="btn">Sign up</a>
                    </div>
                </div>
                <!-- Nav Item -->
            </nav>
                        ...
                        <div class="col-md-6 blog mb-4">
                            <div class="d2c_card_wrapper">
                                ...
                                <h4 class="d2c_card_title">
                                    <a href="./blog_details.php">How Can You Maximize Your Savings in the New Year</a>
                                </h4>
                                <p class="mb-0">Rooms oh fully taken by worse do. To points afraid but may end law lasted was out laughter raptures. Improved own provided blessing may peculiar domestic.</p>
                            </div>
                        </div>
                        <div class="col-md-6 blog mb-4">
                            <div class="d2c_card_wrapper">
                                ...
                                <span>Corporate</span>
                                <h4 class="d2c_card_title">
                                    <a href="./blog_details.php">Funds in Institutional Portfolios Florida Retirement System</a>
                                </h4>
                                <p class="mb-0">Entrepreneurs are businesspeople who find their success by taking risks. In their pursuits, they often become disruptors in established industries.</p>
                            </div>
                        </div>
                        <div class="col-md-6 blog mb-4">
                            <div class="d2c_card_wrapper">
                                ...
                                <span>Corporate</span>
                                <h4 class="d2c_card_title">
                                    <a href="./blog_details.php">How Can You Maximise Your Savings in the New Year</a>
                                </h4>
                                <p class="mb-0">Being an entrepreneur means you can directly improve the lives of others on a local, national or even globalization for the  scale.</p>
                            </div>
                        </div>
                        <div class="col-md-6 blog mb-4">
                            <div class="d2c_card_wrapper">
                                ...
                                <span>Corporate</span>
                                <h4 class="d2c_card_title">
                                    <a href="./blog_details.php">How to Break Into Your Dream Career When No One is Hiring</a>
                                </h4>
                                <p class="mb-0">As your business grows and becomes more profitable, you can provide many people with good-paying jobs and help them achieve a higher quality of life.</p>
                            </div>
                        </div>
                        <div class="col-md-6 blog mb-4 mb-md-0">
                            <div class="d2c_card_wrapper">
                                <div class="d2c_date">
                                    <h6>18 Feb</h6>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    <h2 class="d2c_title">Unlock Your Entrepreneurial Potential Today Take the First Step Towards Success!</h2>
                    <p class="d2c_title_content px-0 px-md-5">Distrusts fulfilled happiness unwilling as explained of difficult. No landlord of peculiar ladyship attended if contempt ecstatic. Loud wish made on is am as hard. Court so avoid in plate hence.</p>
                    <a href="../pages/contact.php" class="btn secondary_btn">Get Started Now</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Most Popular Blog Section Start -->
    <section class="d2c_blog_wrapper d2c_blog_page">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <div class="row">
                        <div class="col-md-6 popular mb-4">
                            <div class="d2c_card_wrapper">
                                <div class="d2c_date">
                                    <h6>18 Feb</h6>
                                </div>
                        ...
                        <div class="col-md-6 popular mb-4 mb-md-0">
                            <div class="d2c_card_wrapper">
                                <div class="d2c_date">
                                    <h6>18 Feb</h6>
                                </div>
                        ...
                        <div class="d2c_popular_btn">
                            <a href="#" id="d2c_popular_more" class="btn mx-auto">
                                load more
                            </a>
                        </div>
                    </div>
